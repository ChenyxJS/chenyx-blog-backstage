      ...
      <DropdownMenu class="w-56">
        <DropdownContent class="bg-primary text-white">
          <DropdownHeader tag="div" class="!font-normal">
            <div class="font-medium">{{ userStore.nickname }}</div>
            <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">
              {{  }}
            </div>
          </DropdownHeader>
          <DropdownDivider class="border-white/[0.08]" />
          <DropdownItem @click="profile" class="hover:bg-white/5">
...
import DarkModeSwitcher from "@/components/dark-mode-switcher/index.vue";
